...
class MCTSAgent(Player):
    def __init__(self):
        self.current_model = models.load_model("value_net_v4")
    ...
    def choose_move(self, move_actions: List[chess.Move], seconds_left: float) -> Optional[chess.Move]:
        ...
        action, _ = self.mc.runSimAndReturnBest(self.board_states, self.simulations, move_set, self.current_model, self.color,
                                                self.c)
